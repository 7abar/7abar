...
| Repo | Description |
|---|---|
| [ai-audit](https://github.com/7abar/ai-audit) | AI-powered Solidity security audit via Claude |
| [ai-commit](https://github.com/7abar/ai-commit) | Generate git commit messages from staged diff |
| [allowance-checker](https://github.com/7abar/allowance-checker) | Scan wallet for active ERC-20 approvals |
| [agent-wallet-sdk](https://github.com/7abar/agent-wallet-sdk) | TypeScript SDK for AI agent wallets |
| [onchain-activity-tracker](https://github.com/7abar/onchain-activity-tracker) | CLI wallet activity tracker with labels |
| [prompt-library](https://github.com/7abar/prompt-library) | Claude prompt templates for Web3 devs |
| [openclaw-solidity-skill](https://github.com/7abar/openclaw-solidity-skill) | OpenClaw skill for Solidity development |

**🎉 Fun & Experiments**
| Repo | Description |
|---|---|
| [on-chain-guestbook](https://github.com/7abar/on-chain-guestbook) | Leave a permanent message on the blockchain |
| [eth-lottery](https://github.com/7abar/eth-lottery) | Decentralized ETH lottery, weekly draws |
| [nft-stamp](https://github.com/7abar/nft-stamp) | Proof-of-attendance NFT with onchain SVG |
| [dead-mans-switch](https://github.com/7abar/dead-mans-switch) | Stop checking in → ETH goes to beneficiary |
| [wallet-roast](https://github.com/7abar/wallet-roast) | Get roasted based on your onchain behavior |
| [crypto-fortune-cookie](https://github.com/7abar/crypto-fortune-cookie) | Deterministic fortune from wallet + gas price |
| [gm-contract](https://github.com/7abar/gm-contract) | Say gm onchain. Build streaks. Leaderboard. |
| [tx-haiku](https://github.com/7abar/tx-haiku) | Turn any tx hash into a haiku |

**📊 Data & Analytics**
| Repo | Description |
|---|---|
| [blockchain-etl-pipeline](https://github.com/7abar/blockchain-etl-pipeline) | ETL pipeline for onchain data |
| [onchain-anomaly-detection](https://github.com/7abar/onchain-anomaly-detection) | Anomaly detection for wallet activity |
| [crypto-sentiment-analyzer](https://github.com/7abar/crypto-sentiment-analyzer) | Crypto sentiment analysis |
